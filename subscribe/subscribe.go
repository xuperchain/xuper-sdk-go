...
func InitWatcher(xuperClient *xchain.XuperClient, bcname string, eventConsumerBufferSize uint, skipEmptyTx bool) *Watcher {
...
// WithBlockRange indicates if exclude tx.
...
// WithBlockRange indicates if exclude tx event.
